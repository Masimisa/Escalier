...
int main(int argc, char **argv){
	...
	string pathImg = "../../data/images/b.jpg";
	string pathXML = "../../data/xml/a.xml";
	...
	imshow("Threshold Windows", th);
	imshow("Cannyed Windows", cannyed_img);
	imshow("Line Windows", line_img);
	imshow("Black Mat Windows", black);
	imshow("Vertical Method", imgV);
	imshow("Horizontal Method", imgH);
